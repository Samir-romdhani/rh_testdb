...
public class CompetenceController implements Serializable {
    ...
    @EJB
    private tn.ensi.dao.CompetenceFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setCompetencePK(new tn.ensi.entities.CompetencePK());
    }
    ...
    public Competence getCompetence(tn.ensi.entities.CompetencePK id) {
    ...
    public static class CompetenceControllerConverter implements Converter {
        ...
        tn.ensi.entities.CompetencePK getKey(String value) {
            tn.ensi.entities.CompetencePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new tn.ensi.entities.CompetencePK();
        ...
        String getStringKey(tn.ensi.entities.CompetencePK value) {
